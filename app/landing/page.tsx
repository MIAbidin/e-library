    ...
    <>
        ...
        <div className="hero-inner">
          <div>
            <div className="hero-badge">
              ✦ Platform Perpustakaan Digital Internal
            </div>
            ...
            <div className="hero-actions">
              ...
              <a href="/auth/register" className="btn-ghost">
                Daftar Sekarang →
              </a>
            </div>
          ...
          <div className="hero-visual">
            <div className="book-stack">
              <div className="book-card book-card-1">
                <div className="book-cover-placeholder" style={{ background: 'linear-gradient(135deg, #1e3a5f, #2563eb)' }}>
                  📘
                </div>
              </div>
              <div className="book-card book-card-2">
                <div className="book-cover-placeholder" style={{ background: 'linear-gradient(135deg, #1a1a2e, #16213e)' }}>
                  📗
                </div>
              </div>
              <div className="book-card book-card-3">
                <div className="book-cover-placeholder" style={{ background: 'linear-gradient(135deg, #2d1b69, #4c1d95)' }}>
                  📙
                </div>
              </div>
      ...
      {featuredBooks && featuredBooks.length > 0 && (
        <section className="section">
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
            ...
            <a href="/books" className="see-all-link">
              Lihat Semua →
            </a>
          </div>
      ...
      <section className="features-section">
        <div className="features-inner">
          ...
          <p className="section-desc">
            Dirancang khusus untuk kebutuhan literasi profesional karyawan perusahaan.
          </p>
            ...
            {[
              {
                ...
                desc: 'PDF viewer bawaan yang nyaman di desktop maupun mobile. Bookmark otomatis di halaman terakhir.',
                bg: '#eff6ff',
              },
              {
                icon: '📊',
                title: 'Statistik Bacaan',
                desc: 'Pantau progres membaca Anda — halaman dibaca, buku selesai, streak harian, dan aktivitas mingguan.',
                bg: '#f0fdf4',
              },
              {
                icon: '🔔',
                title: 'Notifikasi Real-time',
                desc: 'Dapatkan notifikasi setiap ada buku baru atau pengumuman penting dari administrator.',
                bg: '#fef3c7',
              },
              {
                icon: '🏷️',
                title: 'Kategori Terorganisir',
                desc: 'Buku tersusun rapi dalam kategori yang relevan. Filter dan cari dengan mudah.',
                bg: '#fdf2f8',
              },
              {
                icon: '🔒',
                title: 'Akses Aman',
                desc: 'Sistem autentikasi berlapis memastikan hanya karyawan yang berhak dapat mengakses konten.',
                bg: '#f0f9ff',
              },
              {
                icon: '📥',
                title: 'Laporan & Export',
                desc: 'Admin dapat melihat statistik lengkap aktivitas membaca seluruh karyawan dan export CSV.',
                bg: '#f8fafc',
              },
            ].map((f) => (
      ...
      <section className="cta-section">
        <div className="cta-inner">
          <h2 className="cta-title">Siap Mulai Membaca?</h2>
          <p className="cta-desc">
            Daftarkan akun Anda sekarang dan mulai jelajahi koleksi e-book perusahaan.
            Gratis untuk seluruh karyawan.
          </p>
